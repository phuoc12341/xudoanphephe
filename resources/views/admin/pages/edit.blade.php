                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="slug" name="slug"
                                    placeholder="Slug sẽ tự động tạo nếu bạn không nhập" value="{{ $page->slug }}">
                            </div>
...
@push('scripts')
    ...
    <script>
        $(function() {
            var descriptionPage = {!! json_encode($page->description) !!};
            $(function() {
                // Summernote
                ...
                $('#summernote').summernote('code', descriptionPage);
            })
        })
